...
### Task3
Again The Big O is 2n at the moment which requires the computer to go through two loops. The loops can be combine to boost the efficiency of the program by 100% O(n). However, the readability of the program will be reduced as so many conditions need to be checked inside the program.
...
```
    ...
    8
    680
    The total percentage of the Banglore calls 24.815%
